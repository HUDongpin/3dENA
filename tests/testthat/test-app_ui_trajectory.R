...
test_that("trajectory UI exposes resource, selector, overlay, and Plot Tools guidance", {
  ...
  expect_match(html, "trajectory-test-design_guidance", fixed = TRUE)
  expect_match(html, "between-group condition", fixed = TRUE)
  expect_match(html, "not longitudinal", fixed = TRUE)
